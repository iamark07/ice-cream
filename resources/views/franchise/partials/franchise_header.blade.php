...
<div id="mobile_profile_menu" class="lg:hidden flex w-full fixed top-[64px] z-40 -left-full transition-all duration-300" style="height: calc(100dvh - 64px)">
    <div class="w-[75%] h-full p-5 bg-white shadow-lg">
        ...
        <ul class="flex flex-col gap-1 overflow-auto py-3" style="height: calc(100dvh - 164px)">
            ...
            <li>
                <a href="{{ route('franchise_profile') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
                    <i class="ri-user-line text-pink-500"></i>
                    <span>Profile</span>
                </a>
            </li>
            <li>
                <a href="{{ route('franchise_inventory') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
                    <i class="ri-archive-line text-pink-500"></i>
                    <span>Inventory</span>
                </a>
            </li>
            <li>
                <a href="{{ route('franchise_sales_reports') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
                    <i class="ri-bar-chart-line text-pink-500"></i>
                    <span>Sales Reports</span>
                </a>
            </li>
            <li>
                <a href="{{ route('franchise_order_management') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
                    <i class="ri-shopping-cart-line text-pink-500"></i>
                    <span>Orders</span>
                </a>
            </li>
            <li>
                <a href="{{ route('franchise_promotions') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
                    <i class="ri-price-tag-3-line text-pink-500"></i>
                    <span>Promotions</span>
                </a>
            </li>
            <li>
                <a href="{{ route('franchise_customer_reviews') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
                    <i class="ri-star-line text-pink-500"></i>
                    <span>Reviews</span>
                </a>
            </li>
            <li>
                <a href="{{ route('franchise_employee_management') }}" class="flex items-center space-x-3 w-full p-3 rounded-lg hover:bg-pink-100">
