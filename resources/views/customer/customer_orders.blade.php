...
<div class="p-6 bg-gray-50 min-h-screen py-14">
    <div class="max-w-6xl mx-auto bg-white p-6 rounded-lg shadow">       
        <div class="mb-4 grid grid-cols-9 gap-3 items-center">
            <h2 class="order-1 col-span-9 sm:col-span-5 text-xl font-bold">Order & Refund Assistance</h2>
            ...
            <div class="order-3 sm:order-2 col-span-4 md:col-span-4 flex flex-col sm:flex-row justify-center sm:justify-end items-center">
                <button class="bg-pink-500 text-white px-4 py-2 rounded w-full sm:w-fit text-xs sm:text-base">Create Request</button>
            </div> --}}

            <!-- Search Bar -->
            <div class="order-2 col-span-9 sm:col-span-7 w-full relative flex">
                <input type="text" placeholder="Search requests..." class="outline-none border p-2 rounded-l w-full pl-10">
