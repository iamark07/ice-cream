            ...
            <div class="relative">
                ...
                <div id="profile-dropdown"
                    ...
                    <ul class="p-2 text-gray-700">
                        ...
                        <li><a href="{{ route('customer_ticket_management') }}" class="p-2 flex w-full h-full hover:bg-gray-100 rounded transition text-sm" title="Customer Dashboard"><i class="ri-user-settings-line text-pink-400 me-2"></i>Dashboard</a></li>
                        <li><a href="{{ route('admin_dashboard') }}" class="p-2 flex w-full h-full hover:bg-gray-100 rounded transition text-sm"><i class="ri-user-settings-line text-pink-400 me-2"></i>Admin Panel</a></li>
                        <li class="relative">
...
<!-- Mobile Menu -->
<div id="mobile-menu"
    class="lg:hidden fixed top-0 left-0 w-full h-[100dvh] transform -translate-x-full transition-transform duration-300 ease-in-out z-50 flex poppins-regular">
        ...
        <nav class="flex flex-col mt-14 gap-6 text-lg text-gray-800 overflow-auto" style="height: calc(100dvh - 124px);">
            ...
            <div class="relative">
                ...
                <div id="mob-profile-dropdown" class="hidden flex flex-col p-2 bg-white shadow-lg mt-2 rounded-md">
                    <a href="{{ route('profile') }}" class="text-start px-4 py-2 hover:bg-pink-100"><i class="ri-user-2-line text-pink-400 text-lg me-2"></i>My Profile</a>
                    <a href="{{ route('order_history') }}" class="text-start px-4 py-2 hover:bg-pink-100"><i class="ri-shopping-bag-line text-pink-400 text-lg me-2"></i>My Orders</a>
                    <a href="{{ route('profile') }}" class="text-start px-4 py-2 hover:bg-pink-100"><i class="ri-settings-line text-pink-400 text-lg me-2"></i>Settings</a>
                    <a href="{{ route('franchise_dashboard') }}" class="text-start px-4 py-2 hover:bg-pink-100"><i class="ri-user-settings-line text-pink-400 text-lg me-2"></i>Dashboard</a>
                    <a href="{{ route('customer_ticket_management') }}" class="text-start px-4 py-2 hover:bg-pink-100"><i class="ri-user-settings-line text-pink-400 text-lg me-2"></i>Dashboard</a>
                    <a href="{{ route('admin_dashboard') }}" class="text-start px-4 py-2 hover:bg-pink-100"><i class="ri-user-settings-line text-pink-400 text-lg me-2"></i>Admin Panel</a>
