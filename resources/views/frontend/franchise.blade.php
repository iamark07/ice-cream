...
@section('content')
    ...
    <section id="franchise-inquiry" class="bg-gradient-to-r from-blue-400 to-purple-500 py-20 px-6 md:px-10 xl:px-20 text-white text-center">
        <h2 class="text-2xl md:text-4xl font-semibold text-white mb-5 font-pacifico animate-bounce">🍦 Become Our Franchise Partner! 🍦</h2>
            ...
            <div class="col-span-2 lg:col-span-1 bg-white px-5 py-8 md:p-8 rounded-lg shadow-lg text-gray-800">
                ...
                <form id="franchise-form">
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <button type="submit" class="col-span-2 w-full bg-pink-500 text-white py-3 rounded-lg font-semibold shadow-md hover:bg-pink-700 transition-all">Submit Inquiry</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <section class="py-20 px-6 md:px-10 xl:px-20 text-gray-800 text-center">
