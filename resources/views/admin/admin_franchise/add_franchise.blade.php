...
<div class="p-6 bg-gray-50 min-h-screen py-14 flex items-center justify-center">
    <div class="max-w-4xl w-full bg-white p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Add Franchise</h2>
        <form action="" method="POST" class="space-y-5">
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin_franchise')}}"><button class="bg-gray-400 text-white px-5 py-2 rounded-lg hover:bg-gray-500 transition">Cancel</button>
                </a>
